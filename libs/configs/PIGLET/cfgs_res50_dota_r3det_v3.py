...
# ------------------------------------------------
VERSION = 'RetinaNet_PIGLET_20200407'
...
MOMENTUM = 0.9
LR = 5e-5
DECAY_STEP = [SAVE_WEIGHTS_INTE*300, SAVE_WEIGHTS_INTE*400, SAVE_WEIGHTS_INTE*500]
MAX_ITERATION = SAVE_WEIGHTS_INTE*400
WARM_SETP = int(1.0 / 4.0 * SAVE_WEIGHTS_INTE * 25)
