...
# ------------------------------------------------
VERSION = 'RetinaNet_PIGLET_20200603'
...
MOMENTUM = 0.9
LR = 1e-5
DECAY_STEP = [SAVE_WEIGHTS_INTE*1000, SAVE_WEIGHTS_INTE*1200, SAVE_WEIGHTS_INTE*1400]
MAX_ITERATION = SAVE_WEIGHTS_INTE*1200
WARM_SETP = int(1.0 / 4.0 * SAVE_WEIGHTS_INTE * 400)
