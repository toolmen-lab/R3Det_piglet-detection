...
if __name__ == '__main__':
    ...
    featuremap_height, featuremap_width = 512 / 8, 512 / 8
    anchor_list = []
    for i in range(4):
        base_anchor_size = BASE_ANCHOR_SIZE_LIST[i]
        stride = ANCHOR_STRIDE[i]
        tmp_anchors = generate_anchors_pre(featuremap_height, featuremap_width, stride,
                                           np.array(ANCHOR_SCALES) * stride, ANCHOR_RATIOS, 4.0)
