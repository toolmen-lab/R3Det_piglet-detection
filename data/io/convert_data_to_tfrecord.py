...
tf.app.flags.DEFINE_string('VOC_dir', 'PIGLET/train', 'Voc dir')
...
tf.app.flags.DEFINE_string('dataset', 'piglet', 'dataset')
...
def convert_pascal_to_tfrecord():
    ...
    for count, xml in enumerate(glob.glob(xml_path + '/*.xml')):
        ...
        print(img_name)
        assert img_height == img.shape[0] and img_width == img.shape[1]
